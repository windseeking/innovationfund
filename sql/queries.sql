...
INSERT INTO `innovations_ru` (name, short_description, author, main_image_path, market_types, current_stage,
                              money_needed, description, road_map, market_and_appliance, competitive_abilitiy,
                              poll_link_url, presentation_link, partnership, image_1_path,
                              image_2_path, image_3_path)
VALUES ('Лазерный датчик частиц аэрозолей',

        'Прибор, который позволяет в режиме реальног времени показывать степень загрязнения воздуха и давать информацию
        как в мг/м<sup>3</sup>, так и по фракциям.',
        ...
        'есть апробированный прототип и научная и ресурсная базы; проект готов к масштабированию',

        '500 000 EUR',

        '<p class="lead">Лазерный датчик частиц аэрозолей – это прибор, который измеряет загрязненность воздуха:</p>
        <ul class="lead"><li>определяет состав воздуха</li><li>измеряет загрязненность по трём градациям: до 1
        микрона, до 2.5 и до 10</li><li>предоставляет статистику по измеряемым показателям</li><li>сигнализирует
        при превышении заданной нормы</li></ul><div class="col-8 mt-5 mx-auto"><table class="table">
        <tbody>    <tr>      <th scope="row">Покрытие</th>      <td>до 100 м<sup>2</sup></td>    </tr>
        <tr>      <th scope="row">Чувствительность</th>      <td>до 0.3 микронов</td>    </tr>
        </tbody></table></div><iframe width="789" height="444"
        src="https://www.youtube.com/embed/xuqHlMe8kBk" frameborder="0" allow="accelerometer; autoplay;
        encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',

        '<ol class="roadmap">            <li class="passed">Разработки НИИ физики ОНУ им. И.И. Мечникова</li>
        <li class="passed">Создан и апробирован прототип</li>            <li class="passed">Интерес бизнеса</li>
        <li class="passed">Создание продукта</li>            <li class="current">Привлечение инвестиций</li>
        <li class="forthcome text-muted">Доработки и масштабирование</li>            <li class="forthcome text-muted">
        Патентование в ЕС</li>            <li class="forthcome text-muted">Продажа и аренда</li>        </ol>',
        ...
        '<p class="lead">Прибор, разработанный в НИИ физики,        точнее и дешевле зарубежных        образцов.
        Кроме того, институт может        осуществлять монтаж, обслуживание, сертификацию и доработку датчиков, а
        также анализ данных совместно с        компанией-партнером.</p>',
        'https://docs.google.com/forms/d/e/1FAIpQLSeaqPXAgZPbQQYxKGJiAUzRRwhXyN4FVoR6Os_4Z4zxibgY9w/viewform',
        '',

        'Коммерческое соглашение с технической помощью. Компания предоставит техническую часть, а партнер внедрит ее на
        рынок. Например, продавая отдельно или в комплексе с партнерскими продуктами. Лицензионное соглашение. Продажа
        сублицензии партнеру, который будет использовать инновации компании по соглашению и платить роялти.
        Соглашение о техническом сотрудничестве. Разработка и внедрение продукта вместе.',
        '',
       ...
       ('Концентратор солнечной энергии на основе зеркал Френеля',

        'Концентратор солнечной энергии на основе зеркал Френеля, может использоваться как блок солнечной электростанции
        (СЭС), для нагрева различных объектов и сред, для других целей в технологических процессах различных видов
        производств.',
...
INSERT INTO `innovations_en` (name, short_description, author, main_image_path, market_types, current_stage,
                              money_needed, description, road_map, market_and_appliance, competitive_abilitiy,
                              poll_link_url, presentation_link, partnership, image_1_path,
                              image_2_path, image_3_path)
VALUES (),
...
INSERT INTO `innovations_uk` (name, short_description, author, main_image_path, market_types, current_stage,
                              money_needed, description, road_map, market_and_appliance, competitive_abilitiy,
                              poll_link_url, presentation_link, partnership, image_1_path,
                              image_2_path, image_3_path)
VALUES (),
