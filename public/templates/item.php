    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <ul class="nav nav-hover-yellow justify-content-center order-3">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#development">Развитие инновации</a>
                </li>
...
<section style="min-height: 100vh" class="shadowed bg-blue py-5" id="development">
    <div class="container py-3 p-md-5">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="row">
                    <p class="lead text-white">
                     <span style="color: #222224">
                        <i class="far fa-user fa-3x"></i>
                     </span>
                        Продажа приборов с софтом обычному потребителю
                    </p>
                    <p class="lead text-white">
                    <span style="color: #222224">
                        <i class="fas fa-file-contract fa-3x"></i>
                    </span>
                        Проведение замеров для предприятий
                    </p>
                </div>
...
<!--                <div class="col-12 col-md-6">-->
                <p class="lead text-white">
                    ...
                    Продажа и сервис датчиков для предприятий
                </p>
                <p class="lead text-white">
                    <span style="color: #222224">
                        <i class="fas fa-network-wired fa-3x"></i>
                    </span>
                    Развитие сети датчиков и продажа подписки для получения доступа к данным
                </p>
            </div>
        </div>
    </div>
...
<section style="min-height: 100vh" class="shadowed bg-white py-5" id="contact">
    <div class="container py-3 p-md-5">
        <h2 class="display-5">Для получения более детальной
